...
namespace Modules\Dietplate\Providers;
...
class DietplateServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Dietplate';

    protected string $nameLower = 'Dietplate';
