...
use Modules\Dietplate\app\Http\Controllers\GenericController;
use Modules\Dietplate\Repositories\SettingRepository;
...
//            ]);
    ...
    {
        return view('Dietplate::index', ['title' => 'Dashboard']);
    }
