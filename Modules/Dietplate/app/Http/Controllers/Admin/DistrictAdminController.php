...
namespace Modules\Dietplate\app\Http\Controllers\Admin;

use Illuminate\Container\Container as Application;
use Modules\Dietplate\app\Http\Controllers\Admin\GenericAdminController;
use Modules\Dietplate\app\Http\Requests\DistrictRequest;
use Modules\Dietplate\Repositories\DistrictRepository;
...
class DistrictAdminController extends GenericAdminController
{
    ...
    public function index()
    {
        ...
        return view('Dietplate::Admin.district_admin_list', compact('districts','title', 'total', 'search_query'));
    }
    ...
    public function create()
    {
        ...
        return view('Dietplate::Admin.district_admin_form', ['district' => new District(),'title'=>$title]);
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit District';
        return view('Dietplate::Admin.district_admin_form', ['district' => $district,'title'=>$title]);
    }
