...
use Modules\Dietplate\app\Http\Requests\ContactRequest;
use Modules\Dietplate\Models\Activity;
use Modules\Dietplate\Models\City;
use Modules\Dietplate\Models\Contact;
use Modules\Dietplate\Models\District;
use Modules\Dietplate\Models\Feedback;
use Modules\Dietplate\Models\PTSubscription;
use Modules\Dietplate\Models\Setting;
use Modules\Dietplate\Models\Banner;
use Modules\Dietplate\Models\Store;
...
class MainFrontController extends GenericFrontController
{
    ...
    public function index()
    {
        ...
        $subscriptionCategories = SubscriptionCategory::whereHas('subscriptions', function ($query) {
                $query->where('is_web', true);
            })
            ->with(['subscriptions' => function ($query) {
                $query->where('is_web', true)->orderBy('id', 'desc');
            }])
            ->orderBy('id', 'desc')
            ->get();
        ...
        return view('Dietplate::Front.layouts.home', compact('title', 'record', 'lang', 'cover_images', 'images', 'subscriptions', 'subscriptionCategories', 'uncategorizedSubscriptions', 'activities', 'stores'));
    }
    ...
    {
        return view('Dietplate::Front.pages.about', [
    ...
    {
        return view('Dietplate::Front.pages.terms', [
    ...
    {
        return view('Dietplate::Front.pages.policy', [
    ...
    {
        return view('Dietplate::Front.pages.refund', [
    ...
    public function contactCreate()
    {
        ...
        return view('Dietplate::Front.pages.contact', [
...
//        });
    ...
    {
        return view('Dietplate::Front.pages.thanks', [
    ...
    public function home()
    {
        ...
        return view('Dietplate::Front.user.home', [
    ...
    public function downloadApp()
    {
        ...
        return view('Dietplate::Front.pages.download_app', [
