...
use Modules\Dietplate\app\Http\Controllers\Front\AuthFrontController;
use Modules\Dietplate\app\Http\Controllers\Front\GenericFrontController;
use Modules\Dietplate\app\Http\Classes\TabbyService;
use Modules\Dietplate\app\Http\Classes\TamaraService;
use Modules\Dietplate\app\Http\Classes\PaytabsService;
use Modules\Dietplate\app\Http\Requests\SubscriptionRequest;
...
//        $record = (array)$this->getSubscription($id, @$this->mainSettings['subscription']);
        ...
        $title = $record['name'];
        return view('Dietplate::Front.subscription', compact('title', 'record', 'subscriptions'));
    }
    ...
    public function showMobile($id)
    {
        ...
        $title = $record['name'];
        return view('Dietplate::Front.subscription_mobile', compact('title', 'record'));
    }
    ...
    public function invoice($invoice_id)
    {
        ...
        return view('Dietplate::Front.invoice', compact('title', 'invoice', 'qr_img_invoice'));
    }
    ...
    public function invoiceMobile($invoice_id)
    {
        ...
        $qr_img_invoice = @$invoice->qr_code;
        return view('Dietplate::Front.invoice_mobile', compact('title', 'invoice', 'qr_img_invoice'));
    }
...
//        $id = $payment->payment->id;
    ...
    public function error_payment(){
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.error', compact('title'));
    }
    public function tabbyFailure(Request $request){
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.tabby_error_failure', compact('title'));
    }
    public function tabbyCancel(Request $request){
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.tabby_error_cancel', compact('title'));
    }
    ...
    public function tamaraFailure(){
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.tamara_error_failure', compact('title'));
    }
    ...
    public function tamaraCancel(){
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.tamara_error_cancel', compact('title'));
    }
    ...
    protected function sendSubscriptionNotification(int $memberSubscriptionId, string $phone, int $type): void
    {
        try {
            ...
            Http::timeout(10)->post('https://Dietplate.gymmawy.com/api/send-subscription-notification', [
                'lang'                   => 'ar',
    ...
    protected function sendDietOrderAdminEmail(PaymentOnlineInvoice $invoice, ?Member $member = null, ?MemberSubscription $memberSubscription = null): void
    {
        ...
        $this->sendDietOrderAdminEmailFromData([
            ...
            'email'            => $invoice->email,
            'address'          => $invoice->address,
            'gender'           => $member->gender ?? $invoice->gender,
            'dob'              => $member->dob ?? $invoice->dob,
            ...
            'customizeGroups'  => $diet['customize_groups'] ?? [],
            'deliveryType'     => $diet['delivery_type'] ?? null,
            'deliveryArea'     => $diet['delivery_area'] ?? null,
            'deliveryAddress'  => $diet['delivery_address'] ?? null,
            'locationUrl'      => $diet['location_url'] ?? null,
    ...
    public function paytabsCancel(Request $request)
    {
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.paytabs_error_cancel', compact('title'));
    }
    ...
    public function paytabsFailure(Request $request)
    {
        ...
        $title = trans('front.invoice');
        return view('Dietplate::Front.paytabs_error_failure', compact('title'));
    }
