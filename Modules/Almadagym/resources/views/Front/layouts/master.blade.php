...
<head>
    ...
    <meta property="og:image" content="{{asset('Modules/Almadagym/resources/assets/img/logo.png')}}">
    ...
    <meta name="twitter:image" content="{{asset('Modules/Almadagym/resources/assets/img/logo.png')}}">
    ...
    <!-- Favicon -->
    <link href="{{asset('Modules\Almadagym\resources\assets\img\favicon.ico')}}" rel="shortcut icon" type="image/png">
    <link href="{{asset('Modules\Almadagym\resources\assets\img\favicon.ico')}}" rel="icon" type="image/png">

    <!-- Bootstrap Core CSS -->
    <link href="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/css/style_almadagym.css')}}" rel="stylesheet">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top main-nav" id="mainNav">
                    <div class="container">
                        <div class="navbar-brand">
                            <a href="{{asset($lang)}}" class="js-scroll-trigger"><img src="{{asset('Modules/Almadagym/resources/assets/img/logo.png')}}" style="width: 135px; height:51px;object-fit: cover" alt="">
                            </a>
                        </div>
