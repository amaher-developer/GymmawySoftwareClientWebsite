...
@php 
    ...
    <meta property="og:image" content="{{asset('Modules/Almadagym/resources/assets/images/logo.png')}}">
    ...
    <meta name="twitter:image" content="{{asset('Modules/Almadagym/resources/assets/images/logo.png')}}">
    ...
    <!-- Custom CSS -->
    <link href="{{asset('Modules/Almadagym/resources/assets/css/style.css')}}" rel="stylesheet">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top main-nav" id="mainNav" style="padding-top:0px!important;padding-bottom:0px !important;">
                    <div class="container">
                        <div class="navbar-brand">
                            <a href="#page-top" class="js-scroll-trigger"><img src="{{asset('Modules/Almadagym/resources/assets/images/logo.png')}}" style="width: 135px; height:90px;object-fit: contain" alt="">
                            </a>
                        </div>
