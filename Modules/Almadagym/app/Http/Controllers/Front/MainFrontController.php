...
use App\Modules\Almadagym\app\Http\Requests\ContactRequest;
use App\Modules\Almadagym\app\Models\Activity;
use App\Modules\Almadagym\app\Models\Banner;
use App\Modules\Almadagym\app\Models\PTClass;
use App\Modules\Almadagym\app\Models\PTSubscription;
use App\Modules\Almadagym\app\Models\Setting;

use App\Modules\Almadagym\app\Models\Store;
...
class MainFrontController extends GenericFrontController
{
    ...
    public function index()
    {
        ...
        return view('almadagym::Front.layouts.home', compact('title', 'record', 'schedule_banner', 'lang', 'banners', 'images', 'subscriptions', 'activities', 'stores', 'pt_classes'));
    }
    public function banner(){
        ...
        return view('almadagym::Front.pages.banner', compact('title', 'banner', 'lang'));
    ...
    {
        return view('almadagym::Front.pages.about', [
    ...
    {
        return view('almadagym::Front.pages.terms', [
    ...
    {
        return view('almadagym::Front.pages.policy', [
    ...
    public function contactCreate()
    {
        ...
        return view('almadagym::Front.pages.contact', [
...
//        });
    ...
    {
        return view('almadagym::Front.pages.thanks', [
    ...
    public function home()
    {
        ...
        return view('almadagym::Front.user.home', [
    ...
    public function downloadApp()
    {
        ...
        return view('almadagym::Front.pages.download_app', [
