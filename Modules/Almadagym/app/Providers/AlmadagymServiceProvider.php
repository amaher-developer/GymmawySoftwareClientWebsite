...
namespace Modules\Almadagym\Providers;
...
use Modules\Almadagym\Providers\EventServiceProvider;
use Modules\Almadagym\Providers\RouteServiceProvider;

class AlmadagymServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Almadagym';
    protected string $nameLower = 'almadagym';
