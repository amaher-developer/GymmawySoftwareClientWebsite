...
use Modules\Fitdose\app\Http\Requests\DistrictRequest;
use Modules\Fitdose\Repositories\DistrictRepository;
...
class DistrictAdminController extends GenericAdminController
{
    ...
    public function index()
    {
        ...
        return view('fitdose::Admin.district_admin_list', compact('districts','title', 'total', 'search_query'));
    }
    ...
    public function create()
    {
        ...
        return view('fitdose::Admin.district_admin_form', ['district' => new District(),'title'=>$title]);
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit District';
        return view('fitdose::Admin.district_admin_form', ['district' => $district,'title'=>$title]);
    }
