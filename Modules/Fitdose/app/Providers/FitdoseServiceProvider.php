...
namespace Modules\Fitdose\Providers;
...
class FitdoseServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Fitdose';

    protected string $nameLower = 'fitdose';
