...
namespace Modules\Fitdose\Models;
...
//    protected $table = '';
    ...
    protected $casts = ['images' => 'json', 'cover_images' => 'json', 'vat_details' => 'json', 'reservation_details' => 'json', 'wa_details' => 'json', 'payments' => 'json', 'app_config' => 'json'];
