...
<style>
    ...
    .overlay img { position: relative; border-radius: 85px }
    .image .thumb img { width: 100%; padding-bottom: 10px; }
    .image .thumb { margin: 10px auto 0px; border: 1px solid #9e9e9e; }
    .text-nice-light-blue { padding: 0 10px; color: #ffc107; }
    .app li{
        color: #fff !important;
        @if($lang == 'ar')
            text-align: right;
                    ...
                    <div class="pricing-box col-default-mb30 animated bounceInUp slow">
                        ...
                        <div class="pricing-content">
                            ...
                            @if($discountAmount > 0)
                                ...
                                <small style="color: #90ee90; font-size: 12px;">{{$discountLabel}}: -{{number_format($discountAmount, 2)}} {{trans('front.pound_unit')}}</small><br>
                            @endif
