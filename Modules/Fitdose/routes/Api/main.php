...
Route::any('splash', 'Api\FitdoseApiController@splash')->middleware('api');
Route::any('log_errors', 'Api\FitdoseApiController@logErrors')->middleware('api');
Route::any('update_push_token', 'Api\FitdoseApiController@updatePushToken')->middleware('api');
...
//        return \Modules\Fitdose\Models\Setting::all();
//    });
