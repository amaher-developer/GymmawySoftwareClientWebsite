...
@section('scripts')
    @parent
    <script src="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/global/plugins/jquery-ui/jquery-ui.min.js')}}"
            type="text/javascript"></script>
    <script src="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/pages/scripts/ui-modals.min.js')}}"
            type="text/javascript"></script>
