...
<head>
    ...
    <meta property="og:image" content="{{asset('Modules/Cakorinas/resources/assets/img/logo.png')}}">
    ...
    <meta name="twitter:image" content="{{asset('Modules/Cakorinas/resources/assets/img/logo.png')}}">
    ...
    <!-- Custom CSS -->
    <link href="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/css/style_cakorinas.css')}}" rel="stylesheet">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top main-nav" id="mainNav">
                    <div class="container">
                        <div class="navbar-brand">
                            <a href="{{asset($lang)}}" class="js-scroll-trigger"><img src="{{asset('Modules/Cakorinas/resources/assets/img/logo.png')}}" style="width: 135px; height:51px;object-fit: cover" alt="">
                            </a>
                        </div>
