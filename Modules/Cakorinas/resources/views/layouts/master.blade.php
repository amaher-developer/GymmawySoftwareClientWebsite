                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top main-nav" id="mainNav">
                    <div class="container">
                        <div class="navbar-brand">
                            <a href="{{asset($lang)}}" class="js-scroll-trigger"><img src="{{asset('Modules/Cakorinas/resources/assets/img/logo.png')}}" style="width: 135px; height:41px;object-fit: contain" alt="">
                            </a>
                        </div>
