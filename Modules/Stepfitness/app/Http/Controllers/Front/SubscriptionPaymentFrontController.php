...
use App\Modules\Stepfitness\app\Interfaces\PaymentGatewayInterface;
use App\Modules\Stepfitness\app\Http\Controllers\Front\SubscriptionFrontController;
...
//        $record = (array)$this->getSubscription($id, @$this->mainSettings['subscription']);
        ...
        $title = $record['name'];
        return view('stepfitness::Front.subscription_payment', compact('title', 'record', 'subscriptions'));
    }
