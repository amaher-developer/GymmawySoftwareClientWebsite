...
use App\Modules\Stepfitness\app\Http\Controllers\Front\GenericFrontController;
...
class AuthFrontController extends GenericFrontController
{
    ...
    public function showLoginForm()
    {
        if (Auth::check()) {
            ...
            return view('stepfitness::Front.login', compact('title', 'record', 'lang'));
        }
    }
    ...
    public function showProfile()
    {
        ...
        return view('stepfitness::Front.show_profile');
    }
    ...
    {
        return view('stepfitness::Front.edit_profile');
    }
