...
use Modules\Stepfitness\app\Http\Classes\TamaraService;
use Modules\Stepfitness\app\Http\Classes\PaytabsService;
...
use Modules\Stepfitness\Models\MoneyBoxBalance;
...
//        $record = (array)$this->getSubscription($id, @$this->mainSettings['subscription']);
    ...
    public function showMobile($id)
    {
        ...
        $title = $record['name'];
        return view('stepfitness::Front.subscription_mobile', compact('title', 'record'));
    }
