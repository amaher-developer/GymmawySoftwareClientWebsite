@extends('stepfitness::layouts.form')
@section('breadcrumb')
                    ...
                    <div class="tab-pane active" id="info">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  input-data" dir="rtl"
                                   ...
                                   data-bv-notempty-message="{{trans('stepfitness::global.required')}}"/>
                        </div>
                    ...
                    <div class="tab-pane" id="social">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control  input-data" dir="ltr"
                                   ...
                                   data-bv-uri-message="{{trans('stepfitness::stepfitness::global.valid_url')}}"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control  input-data" dir="ltr"
                                   ...
                                   data-bv-uri-message="{{trans('stepfitness::global.valid_url')}}"/>
                        </div>
                    ...
                    <div class="tab-pane" id="contacts">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  input-data" dir="ltr"
                                   ...
                                   data-bv-notempty-message="{{trans('stepfitness::global.required')}}"
                                   data-bv-emailaddress-message="{{trans('stepfitness::global.valid_email')}}"/>
                        </div>
                    ...
                    <div class="tab-pane" id="meta">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-tags-multi" name="meta_keywords_en[]"
                                    ...
                                    required data-bv-notempty-message="{{trans('stepfitness::global.required')}}">
