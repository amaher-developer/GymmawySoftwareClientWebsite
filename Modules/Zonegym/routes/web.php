...
Route::get('/payments/verify/{payment?}', 'Front\SubscriptionFrontController@payment_verify')->name('verify-payment');
Route::post('/payments/verify/{payment?}', 'Front\SubscriptionFrontController@payment_verify')->name('verify-payment');
