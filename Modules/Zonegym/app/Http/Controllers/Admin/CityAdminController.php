...
use Modules\Zonegym\Http\Requests\CityRequest;
use Modules\Zonegym\Repositories\CityRepository;
...
class CityAdminController extends GenericAdminController
{
    ...
    public function index()
    {
        ...
        return view('zonegym::Admin.city_admin_list', compact('cities','title', 'total', 'search_query'));
    }
    ...
    {
        $title = 'Create City';
        return view('zonegym::Admin.city_admin_form', ['city' => new City(),'title'=>$title]);
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit City';
        return view('zonegym::Admin.city_admin_form', ['city' => $city,'title'=>$title]);
    }
