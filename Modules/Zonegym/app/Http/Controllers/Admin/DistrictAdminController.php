...
namespace Modules\Zonegym\Http\Controllers\Admin;

use Illuminate\Container\Container as Application;
use Modules\Zonegym\Http\Controllers\Admin\GenericAdminController;
use Modules\Zonegym\Http\Requests\DistrictRequest;
use Modules\Zonegym\Repositories\DistrictRepository;
...
class DistrictAdminController extends GenericAdminController
{
    ...
    public function index()
    {
        ...
        return view('zonegym::Admin.district_admin_list', compact('districts','title', 'total', 'search_query'));
    }
    ...
    public function create()
    {
        ...
        return view('zonegym::Admin.district_admin_form', ['district' => new District(),'title'=>$title]);
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit District';
        return view('zonegym::Admin.district_admin_form', ['district' => $district,'title'=>$title]);
    }
