...
<style>
    .hero_in.contacts:before {
        background: url({{asset('resources/' . $template_version . '/assets/front/img/bg/contact.jpg')}}) center center no-repeat;
...
@section('script')
    <!-- Validator js -->
    {{--<script src="{{asset('resources/' . $template_version . '/assets/front/js/validator.min.js')}}" type="text/javascript"></script>--}}
