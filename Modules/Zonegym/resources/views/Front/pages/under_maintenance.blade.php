...
@extends('zonegym::Front.layouts.construction_master')
@section('style')
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div id="newsletter_wp" >
                            <form method="post" action="{{asset('resources/' . $template_version . '/assets/front/assets/newsletter.php')}}" id="newsletter" name="newsletter"  autocomplete="off">
                                <div class="row">
