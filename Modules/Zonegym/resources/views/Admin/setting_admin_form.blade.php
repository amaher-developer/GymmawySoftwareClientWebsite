                    ...
                    <div class="tab-pane active" id="info">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  input-data" dir="rtl"
                                   ...
                                   data-bv-notempty-message="{{trans('zonegym::global.required')}}"/>
                        </div>
                    ...
                    <div class="tab-pane" id="social">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control  input-data" dir="ltr"
                                   ...
                                   data-bv-uri-message="{{trans('zonegym::zonegym::global.valid_url')}}"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" class="form-control  input-data" dir="ltr"
                                   ...
                                   data-bv-uri-message="{{trans('zonegym::global.valid_url')}}"/>
                        </div>
                    ...
                    <div class="tab-pane" id="contacts">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  input-data" dir="ltr"
                                   ...
                                   data-bv-notempty-message="{{trans('zonegym::global.required')}}"
                                   data-bv-emailaddress-message="{{trans('zonegym::global.valid_email')}}"/>
                        </div>
                    ...
                    <div class="tab-pane" id="meta">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control js-tags-multi" name="meta_keywords_en[]"
                                    ...
                                    required data-bv-notempty-message="{{trans('zonegym::global.required')}}">
