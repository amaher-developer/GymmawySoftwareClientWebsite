...
Route::get('/payment-success', [\Modules\Sixtyminutes\app\Http\Controllers\Front\SubscriptionFrontController::class, 'success'])->name('payment.success');
Route::get('/payment-failed', [\Modules\Sixtyminutes\app\Http\Controllers\Front\SubscriptionFrontController::class, 'failed'])->name('payment.failed');
