...
Route::name('tabby-error-cancel')->get('/tabby/error/cancel/{payment?}', [\App\Modules\Sixtyminutes\app\Http\Controllers\Front\SubscriptionFrontController::class, 'tabbyCancel']);
Route::name('tabby-error-failure')->get('/tabby/error/failure/{payment?}', [\App\Modules\Sixtyminutes\app\Http\Controllers\Front\SubscriptionFrontController::class, 'tabbyFailure']);
