...
{{--                            <p>It is a long established fact that a reader </p>--}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-12  ">
                                                ...
                                                <input type="date" name="joining_date" class="form-control"
                                                       ...
                                                       max="{{\Carbon\Carbon::now()->addMonths(1)->format('Y-m-d')}}"
                                                       required>
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-md-offset-3"></div>
                            ...
                            @php
                                ...
                                // Mada is permanently disabled below because the Nafezly Paytabs package it
                                // depends on isn't installed in this repo, so it can never actually work.
