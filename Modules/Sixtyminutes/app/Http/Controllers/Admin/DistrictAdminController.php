...
namespace Modules\Sixtyminutes\app\Http\Controllers\Admin;

use Illuminate\Container\Container as Application;
use Modules\Sixtyminutes\app\Http\Controllers\Admin\GenericAdminController;
use Modules\Sixtyminutes\app\Http\Requests\DistrictRequest;
use Modules\Sixtyminutes\Repositories\DistrictRepository;
...
class DistrictAdminController extends GenericAdminController
{
    ...
    public function index()
    {
        ...
        return view('sixtyminutes::Admin.district_admin_list', compact('districts','title', 'total', 'search_query'));
    }
    ...
    public function create()
    {
        ...
        return view('sixtyminutes::Admin.district_admin_form', ['district' => new District(),'title'=>$title]);
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit District';
        return view('sixtyminutes::Admin.district_admin_form', ['district' => $district,'title'=>$title]);
    }
