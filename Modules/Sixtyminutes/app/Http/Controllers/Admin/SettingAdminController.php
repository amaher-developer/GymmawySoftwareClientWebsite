...
use Modules\Sixtyminutes\app\Http\Requests\SettingRequest;
...
class SettingAdminController extends GenericAdminController
{
    ...
    public function edit()
    {
        ...
        return view('sixtyminutes::Admin.setting_admin_form', ['title'=>$title]);
    }
    ...
    private function prepare_inputs($inputs)
    {
        ...
        return view('sixtyminutes::index', ['title' => 'Dashboard']);
        unset($inputs[$input_file]);
        }
