...
use App\Modules\Sixtyminutes\app\Interfaces\PaymentGatewayInterface;
use App\Modules\Sixtyminutes\app\Http\Controllers\Front\SubscriptionFrontController;
...
//        $record = (array)$this->getSubscription($id, @$this->mainSettings['subscription']);
        ...
        $title = $record['name'];
        return view('sixtyminutes::Front.subscription_payment', compact('title', 'record', 'subscriptions'));
    }
