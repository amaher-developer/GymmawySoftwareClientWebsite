...
class MainFrontController extends GenericFrontController
{
    ...
    public function index()
    {
        ...
        return view('sixtyminutes::Front.layouts.home', compact('title', 'record', 'schedule_banner', 'lang', 'banners', 'images', 'subscriptions', 'activities', 'stores', 'pt_classes'));
    }
    public function banner(){
        ...
        return view('sixtyminutes::Front.pages.banner', compact('title', 'banner', 'lang'));
    ...
    {
        return view('sixtyminutes::Front.pages.about', [
    ...
    {
        return view('sixtyminutes::Front.pages.terms', [
    ...
    {
        return view('sixtyminutes::Front.pages.policy', [
    ...
    public function contactCreate()
    {
        ...
        return view('sixtyminutes::Front.pages.contact', [
...
//        });
    ...
    {
        return view('sixtyminutes::Front.pages.thanks', [
    ...
    public function home()
    {
        ...
        return view('sixtyminutes::Front.user.home', [
    ...
    public function downloadApp()
    {
        ...
        return view('sixtyminutes::Front.pages.download_app', [
