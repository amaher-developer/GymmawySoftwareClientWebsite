...
<head>
    ...
    <meta property="og:image" content="{{asset('Modules/Premier/resources/assets/img/logo.png')}}">
    ...
    <meta name="twitter:image" content="{{asset('Modules/Premier/resources/assets/img/logo.png')}}">
    ...
    <!-- Favicon -->
    <link href="{{asset('Modules\Premier\resources\assets\img\favicon.png')}}" rel="shortcut icon" type="image/png">
    <link href="{{asset('Modules\Premier\resources\assets\img\favicon.png')}}" rel="icon" type="image/png">

    <!-- Bootstrap Core CSS -->
    <link href="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/css/bootstrap.min.css')}}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{asset('resources/' . env('TEMPLATE_NUM', '') . '/assets/css/style_premier.css')}}" rel="stylesheet">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <p style="margin-bottom: 6px;">
                    ...
                    |
                    <a href="https://premierfitnes.com/{{$lang}}/refund-policy" target="_blank" style="color:#aaa; margin: 0 8px;">{{trans('front.refund_policy')}}</a>
                </p>
