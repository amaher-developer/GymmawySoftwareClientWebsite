...
namespace Modules\Premier\app\Http\Controllers\Api;
use Illuminate\Container\Container as Application;
use Modules\Access\Models\User;
use Modules\Premier\app\Http\Controllers\GenericController;
use Modules\Premier\Repositories\SettingRepository;
