...
use Modules\Premier\app\Http\Requests\CityRequest;
use Modules\Premier\Repositories\CityRepository;
...
class CityAdminController extends GenericAdminController
{
    ...
    public function index()
    {
        ...
        return view('premier::Admin.city_admin_list', compact('cities','title', 'total', 'search_query'));
    }
    ...
    {
        $title = 'Create City';
        return view('premier::Admin.city_admin_form', ['city' => new City(),'title'=>$title]);
    }
    ...
    public function edit($id)
    {
        ...
        $title = 'Edit City';
        return view('premier::Admin.city_admin_form', ['city' => $city,'title'=>$title]);
    }
