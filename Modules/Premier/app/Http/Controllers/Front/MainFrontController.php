...
use Modules\Premier\app\Http\Requests\ContactRequest;
use Modules\Premier\Models\Activity;
use Modules\Premier\Models\City;
use Modules\Premier\Models\Contact;
use Modules\Premier\Models\District;
use Modules\Premier\Models\Feedback;
use Modules\Premier\Models\PTSubscription;
use Modules\Premier\Models\Setting;
use Modules\Premier\Models\Banner;
use Modules\Premier\Models\Store;
...
class MainFrontController extends GenericFrontController
{
    ...
    public function index()
    {
        ...
        return view('premier::Front.layouts.home', compact('title', 'record', 'lang', 'cover_images', 'images', 'subscriptions', 'activities', 'stores'));
    }
    ...
    {
        return view('premier::Front.pages.about', [
    ...
    public function contactCreate()
    {
        ...
        return view('premier::Front.pages.contact', [
...
//        });
    ...
    {
        return view('premier::Front.pages.thanks', [
    ...
    public function home()
    {
        ...
        return view('premier::Front.user.home', [
    ...
    public function downloadApp()
    {
        ...
        return view('premier::Front.pages.download_app', [
