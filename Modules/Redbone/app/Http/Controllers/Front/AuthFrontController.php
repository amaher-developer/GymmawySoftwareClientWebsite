...
use App\Modules\Redbone\app\Http\Controllers\Front\GenericFrontController;
...
class AuthFrontController extends GenericFrontController
{
    ...
    public function showLoginForm()
    {
        if (Auth::check()) {
            ...
            return view('redbone::Front.login', compact('title', 'record', 'lang'));
        }
    }
    ...
    public function showProfile()
    {
        ...
        return view('redbone::Front.show_profile');
    }
    ...
    {
        return view('redbone::Front.edit_profile');
    }
