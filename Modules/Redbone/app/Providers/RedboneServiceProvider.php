...
namespace Modules\Redbone\Providers;
...
class RedboneServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'Redbone';

    protected string $nameLower = 'redbone';
