...
<div class="mail-main">
    <div class="container">
        <div class="mail-description" @if($lang=='ar') style="direction: rtl; text-align: right" @endif>
            <h2>{{trans('passwords.reset_subject')}}</h2>

            <br/>
            <div class="mail-links">
                <p>{{trans('passwords.reset_line_1')}}</p>
                <br/>
                <p><a href ="{{url($lang.'/password/reset', $token)}}">{{trans('passwords.reset_action')}}</a></p>
                <br/>
                <p>{{trans('passwords.reset_line_2')}}</p>
            </div>
        </div>
