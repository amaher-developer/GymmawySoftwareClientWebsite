...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    {{--<tr>--}}
    {{--<td align="center" valign="top" style="padding: 15px 0;border-bottom:1px dashed #000" class="logo">--}}
    {{--<a href="{{route('home')}} " target="_blank">--}}
    {{--<img alt="Logo" src="{{$logo}}" width="163" height="90" style="display: block; font-family: Helvetica, Arial, sans-serif; color: #ffffff; font-size: 16px;" border="0">--}}
    {{--</a>--}}
    {{--</td>--}}
    {{--</tr>--}}
    {{--</table>--}}
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                class="padding">
                                                {{trans('global.hello')}}@if(!empty($user)){{" - ".$user['name']}}@endif
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <tr>
                    <td align="center"
                        ...
                        <p>
                            <label>{{trans('global.ticket_subject')}} </label>
                            <br/>
                        ...
                        <p>
                            <label>{{trans('global.ticket_body')}} </label>
                            <br/>
                        ...
                        <p>
                            <label>{{trans('global.code')}} </label>
                            <br/>
                            @if(isset($ticket['code']) && !empty($ticket['code']))
                                <a href="{{route('replyToTicketByLink',$ticket['code'])}}"
                                   target="_blank">{{trans('global.reply_to_ticket')}}</a>
